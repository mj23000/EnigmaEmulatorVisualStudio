namespace SRP_Enigma
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.rotor3RotorV.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor3RotorIV
			// 
			...
			this.rotor3RotorIV.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor3RotorIII
			// 
			this.rotor3RotorIII.AutoSize = true;
			this.rotor3RotorIII.Checked = true;
			...
			this.rotor3RotorIII.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor3RotorII
			// 
			...
			this.rotor3RotorII.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor3RotorI
			// 
			...
			this.rotor3RotorI.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor2Valg
			// 
			...
			this.rotor2RotorV.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor2RotorIV
			// 
			...
			this.rotor2RotorIV.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor2RotorIII
			// 
			...
			this.rotor2RotorIII.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor2RotorII
			// 
			this.rotor2RotorII.AutoSize = true;
			this.rotor2RotorII.Checked = true;
			...
			this.rotor2RotorII.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor2RotorI
			// 
			...
			this.rotor2RotorI.CheckedChanged += new System.EventHandler(this.rotor_CheckedChanged);
			// 
			// rotor1Valg
			// 
			...
			this.rotor1RotorI.Checked = true;
